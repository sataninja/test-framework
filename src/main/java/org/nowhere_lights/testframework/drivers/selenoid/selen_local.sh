...
curl -s https://aerokube.com/cm/bash | bash \
    && ./cm selenoid start --force --vnc --tmpfs 256 --args '-limit 10 -timeout 1m -service-startup-timeout 3m -session-attempt-timeout 1m' --browsers 'chrome;firefox' --last-versions 2 \
